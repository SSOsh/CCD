...
public class bsDislikeHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bsDislikeHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bsDislikeHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bsDislikeHttp(String n) {
        arr = n.split("/");
    }
