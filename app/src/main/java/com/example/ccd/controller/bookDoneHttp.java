...
public class bookDoneHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookDoneHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookDoneHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bookDoneHttp(String n) {
        arr = n.split("/");
    }
