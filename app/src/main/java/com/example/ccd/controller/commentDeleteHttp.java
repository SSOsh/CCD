...
public class commentDeleteHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public commentDeleteHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public commentDeleteHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public commentDeleteHttp(String n) {
        arr = n.split("/");
    }
