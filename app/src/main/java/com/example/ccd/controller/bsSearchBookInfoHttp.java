...
public class bsSearchBookInfoHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bsSearchBookInfoHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bsSearchBookInfoHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bsSearchBookInfoHttp(String n) {
        arr = n.split("/");
    }
    ...
    protected String doInBackground(String... voids) {
        ...
        try {
            ...
            str = str + ip + "bsSearchBookInfo.jsp";
