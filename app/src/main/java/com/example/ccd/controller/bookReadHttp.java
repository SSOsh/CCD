...
public class bookReadHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookReadHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookReadHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bookReadHttp(String n) {
        arr = n.split("/");
    }
