...
public class bsBookLikeHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bsBookLikeHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bsBookLikeHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bsBookLikeHttp(String n) {
        arr = n.split("/");
    }
