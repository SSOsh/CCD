...
public class bookDislikeHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookDislikeHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookDislikeHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bookDislikeHttp(String n) {
        arr = n.split("/");
    }
