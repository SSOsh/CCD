...
public class searchHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public searchHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public searchHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public searchHttp(String n) {
        arr = n.split("/");
    }
