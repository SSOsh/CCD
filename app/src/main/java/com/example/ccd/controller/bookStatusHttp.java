...
public class bookStatusHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookStatusHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookStatusHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bookStatusHttp(String n) {
        arr = n.split("/");
    }
