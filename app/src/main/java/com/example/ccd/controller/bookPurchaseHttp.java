...
public class bookPurchaseHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookPurchaseHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookPurchaseHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bookPurchaseHttp(String n) {
        arr = n.split("/");
    }
