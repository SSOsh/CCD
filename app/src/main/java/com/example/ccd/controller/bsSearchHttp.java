...
public class bsSearchHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bsSearchHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bsSearchHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bsSearchHttp(String n) {
        arr = n.split("/");
    }
