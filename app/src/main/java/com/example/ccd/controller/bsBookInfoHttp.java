...
public class bsBookInfoHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bsBookInfoHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bsBookInfoHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public bsBookInfoHttp(String n) {
        arr = n.split("/");
    }
