...
public class commentModifyHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public commentModifyHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public commentModifyHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }

    public commentModifyHttp(String n) {
        arr = n.split("/");
    }
