...
public class bookInfoHttp extends AsyncTask<String, String, String> {
    String strUrl;
    String[] arr;
    ...
    public bookInfoHttp(String n, Context context) {
        arr = n.split("/");
        this.context = context;
    }

    public bookInfoHttp(String n, View view) {
        arr = n.split("/");
        this.context = context;
    }
